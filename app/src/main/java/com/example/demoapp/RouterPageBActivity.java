...
public class RouterPageBActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText("页面 B");
        tvInfo.setText("当前在页面 B\n\n" +
                "路由栈：主页 → 页面A → 页面B\n\n" +
                "操作说明：\n" +
                "• 前进到页面C：继续添加新页面\n" +
                "• 替换为页面C：用页面C替换当前页面B\n" +
        ...
        btnForward.setOnClickListener(v -> {
            Toast.makeText(this, "前进到页面C", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(RouterPageBActivity.this, RouterPageCActivity.class);
